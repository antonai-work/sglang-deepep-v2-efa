# Acceptance Status — sglang-deepep-v2-efa
...
SGLang 0.5.11 native Path B + DeepEP V2 inference overlay. Validates real /generate on Qwen3-30B-A3B-FP8 over 2-pod EFA. Wave 38.8-38.12 PASS evidence in commit history.
...
- Native Path B (no shim)
- /generate 2-node Qwen3-FP8 PASS
- Wave 32.4-32.6 patches for IPC + signature drift
- Wave 38.8-38.12 native V2 dispatch/combine
